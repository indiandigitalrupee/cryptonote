...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x7678;
...
const char     CRYPTONOTE_NAME[]                             = "IndianDigitalRupee";
...
const int      P2P_DEFAULT_PORT                              = 8687;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 8786;
